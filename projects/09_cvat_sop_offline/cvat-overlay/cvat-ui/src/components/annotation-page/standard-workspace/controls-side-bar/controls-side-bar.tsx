...
export default function ControlsSideBarComponent(props: Props): JSX.Element {
    ...
    let rectangleLabelAvailable = withUnspecifiedType;
    ...
    labels.forEach((label: Label) => {
        rectangleLabelAvailable = rectangleLabelAvailable || label.type === LabelType.RECTANGLE;
        ...
        <ContainerHeightContext.Provider value={containerHeight}>
            <Layout.Sider ref={containerRef} className='cvat-canvas-controls-sidebar' theme='light' width={44}>
                ...
                <ObservedDrawRectangleControl
                    ...
                    disabled={controlsDisabled || !rectangleLabelAvailable}
                    disabledReason={!rectangleLabelAvailable ?
                        '当前任务没有矩形类型标签，请先在任务设置中添加 Rectangle 标签' :
                        undefined}
                />
                {
