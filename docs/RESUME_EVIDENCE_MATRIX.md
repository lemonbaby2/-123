...
| CVAT 中文离线标注与 SOP 平台 | CVAT 2.73.1 本地化、多架构容器、矩形十字准星、MP4 标注导出、Windows 启动器与 SOP 本机封装 | `projects/09_cvat_sop_offline` 的 UI 覆盖层、Compose、启动器源码、恢复脚本、静态测试及脱敏验收记录 | 业务视频、生产数据库、账号、模型权重、完整镜像和目标 Windows 主机最终验收 |
